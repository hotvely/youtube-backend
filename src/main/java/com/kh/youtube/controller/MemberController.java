...
public class MemberController
{
    ...
    public ResponseEntity<List<Channel>> showAllByMember(@RequestParam String id)
    {
        return ResponseEntity.status(HttpStatus.OK).body(channelService.showAllByMember(id));
    }
